...
const AboutSection = () => {
  return (
    <section id="about" className="py-20 bg-card-foreground dark:bg-card">
            ...
            <div className="space-y-6">
              ...
              <div className="flex flex-wrap gap-4">
                <div className="bg-primary-800/20 dark:bg-primary-200/20 border border-primary/20 rounded-lg px-4 py-2">
                  <span className="text-primary-800 dark:text-primary-200 font-medium flex items-center flex-col"><span className="text-primary-800 dark:text-primary-200 text-h4 "><NumberCounter end={4} duration={1500} />+</span> Years Experience</span>
                </div>
                <div className="bg-primary-800/20 dark:bg-primary-200/20 border border-primary/20 rounded-lg px-4 py-2">
                  <span className="text-primary-800 dark:text-primary-200 font-medium flex items-center flex-col"><span className="text-primary-800 dark:text-primary-200 text-h4 "><NumberCounter end={50} duration={1500} />+</span> Projects Completed</span>
                </div>
              </div>
            </div>
