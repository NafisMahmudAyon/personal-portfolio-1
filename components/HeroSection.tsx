...
const HeroSection = () => {
  ...
  return (
    <section id="home" className="min-h-screen flex items-center justify-center relative overflow-hidden  sm:bg-red-50 dark:sm:bg-primary-950 md:bg-blue-50 dark:md:bg-blue-950 lg:bg-pink-50 lg:dark:bg-pink-950">
