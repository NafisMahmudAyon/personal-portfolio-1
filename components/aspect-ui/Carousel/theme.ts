...
export const carouselTheme: KeepCarouselTheme = {
  ...
  controls: {
    wrapper:
      'flex items-center justify-between mt-[1.8rem] absolute top-0 left-0 w-full',
    button: {
    ...
    indicators: {
      container:
        'flex flex-wrap items-center gap-2 absolute bottom-0 left-1/2 -translate-x-1/2 w-full bg-primary-50',
